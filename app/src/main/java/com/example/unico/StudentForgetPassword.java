        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Contact_No.length()==10)
                {
                    ...
                    rs=Integer.toString(otp1)+Contact_No.substring(2,5);

                    int permissionCheck = ContextCompat.checkSelfPermission(StudentForgetPassword.this, Manifest.permission.SEND_SMS);

                    if (permissionCheck == PackageManager.PERMISSION_GRANTED) {
                        MyMessage(rs);
                    }
                    else {
                        ActivityCompat.requestPermissions(StudentForgetPassword.this, new String[]{Manifest.permission.SEND_SMS}, 0);
                    }
                    final Dialog d1=new Dialog(StudentForgetPassword.this);
                    ...
                    check.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            {
                                d1.dismiss();
                                final Dialog d = new Dialog(StudentForgetPassword.this);
                                d.setContentView(R.layout.studentdialog);
                                ...
                                b13.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        {
                                            Query q = dr.child(year+"Students").orderByChild("contact").equalTo(Contact_No);
                                            q.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                    ...
                                                    for(DataSnapshot ds:dataSnapshot.getChildren())
                                                    {
                                                        ...
                                                        Toast.makeText(StudentForgetPassword.this, "Password Changed Successfully!!", Toast.LENGTH_SHORT).show();
                                                        Intent i=new Intent(StudentForgetPassword.this,StudentSignin2.class);
                                                        startActivity(i);
                                                        finish();
...
//
                            ...
                            {
                                Toast.makeText(StudentForgetPassword.this, "Incorrect Code", Toast.LENGTH_SHORT).show();
                            }
                        }
                ...
                {
                    Toast.makeText(StudentForgetPassword.this, "Please Enter Valid Phone Number", Toast.LENGTH_SHORT).show();
                }
                }
            ...
            private void MyMessage(String locMessage) {
                ...
                Toast.makeText(StudentForgetPassword.this, "Message Sent", Toast.LENGTH_SHORT).show();
