...
public class StudentRegistry extends AppCompatActivity {
    ...
    int TotalAttendance=0,MarkedAttendance=0;
    int s12=0;
    boolean b;
        ...
        register.setOnClickListener(new View.OnClickListener() {
           ...
           //     s9=spin3.getSelectedItem().toString();
            //    s10 = answer.getText().toString().trim();
                ...
                if (b==true)
                {
                    yearViseClasses obj2=new yearViseClasses(s1,s2,s3,s4,s5,s6,s7,s8,"null",dd,s12,s13);
                    ...
                    Toast.makeText(StudentRegistry.this, "Registered Successfully", Toast.LENGTH_SHORT).show();


                    final Dialog d=new Dialog(StudentRegistry.this);
                //    final Dialog d=new Dialog(this);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent i=new Intent(StudentRegistry.this,ManasgementMain.class);
                            startActivity(i);
                            finish();
                ...
                {
                    Toast.makeText(StudentRegistry.this, "Error While Registering User", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
{
    public String name,email,contact,roll_no,gender,year,username,password,attendance,date,fee_status;
    public int marks;
    public yearViseClasses(String name, String email, String contact, String roll_no, String gender, String year, String username, String password,String attendance, String date,int marks,String fee_status)
    {
        this.name=name;
        this.email=email;
