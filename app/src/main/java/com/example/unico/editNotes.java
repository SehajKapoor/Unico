...
public class editNotes extends Fragment {
    ...
    private EditNotesViewModel2 mViewModel;

    public static editNotes newInstance() {
        return new editNotes();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.edit_notes_fragment2, container, false);
        ...
        deleteNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Query q=dr.child(year+"Notes"+"/"+user).orderByChild("heading").equalTo(h);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(EditNotesViewModel2.class);
